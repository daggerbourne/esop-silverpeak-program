...
### A. Create and Edit .env File (YOUR CONFIGURATION GOES HERE)
...
```bash
# REQUIRED - Add your SilverPeak credentials:
...
**⚠️ ALL configuration goes in .env file - nowhere else!**

### B. Rename Docker Compose File (DO NOT EDIT THIS FILE)

```bash
# Just rename it - don't edit it!
# Windows:
